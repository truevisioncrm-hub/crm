...
import { Search, Filter, MapPin, BedDouble, Bath, Maximize, Plus, X, Home, IndianRupee, Save, Image, Loader2 } from "lucide-react";
    ...
    return (
        <div className="space-y-8 animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    <h1 className="text-2xl font-bold text-neutral-900">My Sell Properties</h1>
            ...
            {loading ? (
                ...
                <div className="flex flex-col items-center justify-center py-20 text-center bg-white rounded-3xl border border-neutral-100 shadow-sm">
                    ...
                    <p className="text-sm text-neutral-400 mb-6 max-w-[300px]">Start adding your property listings to showcase them.</p>
                        ...
                        <div key={property.id} className="group bg-white border border-neutral-100 rounded-3xl overflow-hidden hover:shadow-xl hover:-translate-y-1 transition-all duration-300 card-shadow flex flex-col">
                            ...
                            <div className="p-5 flex-1 flex flex-col">
                                ...
                                <div className="pt-4 border-t border-neutral-100 flex items-center justify-between">
                                    <span className="text-xl font-bold text-primary">₹{Number(property.price).toLocaleString('en-IN')}</span>
                ...
                <div className="fixed inset-0 bg-black/40 backdrop-blur-sm z-50 flex items-center justify-center p-4" onClick={() => setShowForm(false)}>
                    <form className="bg-white rounded-3xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto" onClick={(e) => e.stopPropagation()} onSubmit={handleSave}>
                        <div className="p-6 border-b border-neutral-100 flex items-center justify-between sticky top-0 bg-white rounded-t-3xl z-10">
                            <div>
                                <h2 className="text-lg font-bold text-neutral-900">Add New Sell Property</h2>
                        ...
                        <div className="p-6 space-y-5">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div>
                                    ...
                                    <input required name="price" type="number" placeholder="e.g. 12000000" className="w-full px-4 py-2.5 border border-neutral-200 rounded-xl text-sm focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none" />
                                </div>
                                <div>
                            ...
                            <div>
                                ...
                                <textarea name="description" rows={3} placeholder="Describe the property..." className="w-full px-4 py-2.5 border border-neutral-200 rounded-xl text-sm focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none resize-none" />
                            </div>
                        </div>
